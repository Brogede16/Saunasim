      ...
      <section className="control-dock" aria-label="Venue controls">
        ...
        {activePanel === "overview" && state.lastReport && (
          <section className="week-report" aria-label="Latest weekly report">
            ...
            {!!state.lastReport.turnedAwayFromGus && <div className="ledger-breakdown">{state.lastReport.turnedAwayFromGus} visit{state.lastReport.turnedAwayFromGus === 1 ? "" : "s"} wanted this Gus but there was no room this week</div>}
